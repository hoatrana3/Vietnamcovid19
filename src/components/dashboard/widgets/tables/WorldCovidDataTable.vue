<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    <div>
        ...
        <b-pagination
                ...
                aria-controls="glob-covid-table"
        ></b-pagination>
    </div>
</template>
    ...
    export default {
        ...
        mounted() {
            window.addEventListener(
                "orientationchange",
                () => {
                    DashboardUtils.customizeBStickyCols(document.getElementById('glob-covid-table'))
                }
            );
        ...
        methods: {
            ...
            calculateWorldData(rawData) {
                const result = {
                    country: `${this.$t('places.all-nations')} (${rawData.length})`,
                    country_vn: `${this.$t('places.all-nations')} (${rawData.length})`,
            ...
            observeDataTable() {
                const tableDom = document.getElementById('glob-covid-table');
